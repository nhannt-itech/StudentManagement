...
//        datasets: [{
//            data: [],
//            backgroundColor: ['#4e73df', '#bb2124'],
//            hoverBackgroundColor: ['#4e73df', '#bb2124'],
...
//    PieChart_Call('/manager/statistic/StatisticGender', data = null);

//})


//function PieChart_Call(url, data = null) {//data này có thể có có thể ko
//    if (data == null) {
